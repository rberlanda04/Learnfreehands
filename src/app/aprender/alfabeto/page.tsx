      ...
      <main id="main-content">
        <section className="section">
          <div className="section-header">
            <span className="section-tag">Módulo 1 • Alfabeto WikiLibras</span>
            <h1 className="section-title">Alfabeto de Libras — A a Z</h1>
            <p className="section-subtitle">
              Cada letra vem com a descrição do gesto, instrução passo a passo e integração direta com o avatar 3D do VLibras.
            </p>
          </div>
            ...
            {LIBRAS_ALPHABET.map((sign) => (
              <div key={sign.id} className="card" style={{
                ...
                <div style={{ marginTop: "var(--space-4)" }}>
                  <SignAvatar sign={sign} onShowDetails={() => setActiveSign(sign)} />
                </div>
              </div>
            ))}
          </div>
